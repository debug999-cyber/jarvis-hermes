...
| 🕹 **HUD** | «Cinematic Glass» веб-интерфейс: арк-реактор на canvas (реагирует на голос), стеклянные панели по требованию (Activity / System / BRAIN), панели агента (текст/картинки/видео/веб/графики), чат, голос в браузере, cinematic boot | `hud/` |
...
<p align="center"><sub>Спокойный режим: реактор, вопрос и ответ. Больше ничего не отвлекает.</sub></p>

<p align="center"><img src="docs/img/hud-panels.jpg" alt="HUD: панели" width="100%"></p>
<p align="center"><sub>По запросу: лента действий агента (A), график от инструмента <code>jarvis_hud</code>, алерт watchdog'а, режим Focus.</sub></p>
